...
module.exports = {
  install(less, pluginManager, functions) {
    ...
    functions.add('framework7_coreIconsFont', () => {
      const iconsFontBase64 = base64Encode('./src/app/icons/font/framework7-app-icons.woff');
      return iconsFontBase64;
    });
    functions.add('framework7_skeletonFont', () => {
      const iconsFontBase64 = base64Encode('./src/app/icons/font/framework7-skeleton.woff');
      return iconsFontBase64;
    });
  },
};
